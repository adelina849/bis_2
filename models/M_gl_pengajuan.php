<?php
	class M_gl_pengajuan extends CI_Model 
	{
        ...
        {
			$query = "SELECT MAX(no_reg + '0.00') + 1 AS NO_REG_FORMAT FROM tb_pengajuan WHERE kode_kantor = '".$kode_kantor."';";
        ...
        {
			$query = "SELECT MAX(no_reg + '0.00') + 1 AS NO_KODE_FORMAT FROM tb_pengajuan WHERE kode_kantor = '".$kode_kantor."' AND LEFT(no_kode,1) = '".$jenis."' ;";
