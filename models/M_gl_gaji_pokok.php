...
class M_gl_gaji_pokok extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id_gaji_pokok,A.id_karyawan,no_karyawan,nama_karyawan,nama_jabatan,tanggal,besar_gaji');
    ...
    {
      $this->db->select('A.id_gaji_pokok,A.id_karyawan,no_karyawan,nama_karyawan,tanggal,besar_gaji,A.kode_kantor');
