	...
	class M_gl_h_penjualan extends CI_Model 
	{
		...
		function list_rekam_medis($cari,$order_by,$limit,$offset)
		{
			...
			"
				...
				INNER JOIN tb_d_penjualan AS D ON A.id_h_penjualan = D.id_h_penjualan AND A.kode_kantor = D.kode_kantor
				".$cari."
				".$order_by."
				LIMIT ".$offset.",".$limit."
			";
		...
		function list_pendaftaran_perawatan_lanjutan($cari,$order_by,$limit,$offset)
		{
			...
			"
				...
				LEFT JOIN tb_karyawan AS F ON A.id_ass_dok2 = F.id_karyawan AND A.kode_kantor = F.kode_kantor
				".$cari."
				".$order_by."
				LIMIT ".$offset.",".$limit."
			";
		...
		function ubah_h_penjualan_sts_saja_for_slim($kode_kantor,$id_h_penjualan,$status,$ket_penjualan2)
		{
			$strquery=
			"
				UPDATE tb_h_penjualan SET sts_penjualan = '".$status."', ket_penjualan2 = '".$ket_penjualan2."' , tgl_updt = NOW() WHERE kode_kantor = '".$kode_kantor."' AND id_h_penjualan = '".$id_h_penjualan."'
			";
		...
		function ubah_h_penjualan_sts_saja($kode_kantor,$id_h_penjualan,$status,$pajak,$diskon,$ket_penjualan2)
		{
			$strquery=
			"
				UPDATE tb_h_penjualan SET sts_penjualan = '".$status."', pajak = '".$pajak."', diskon = '".$diskon."', ket_penjualan2 = '".$ket_penjualan2."' , tgl_updt = NOW() WHERE kode_kantor = '".$kode_kantor."' AND id_h_penjualan = '".$id_h_penjualan."'
			";
		...
		function ubah_h_penjualan_media_transaksi($id_h_penjualan,$kode_kantor,$media_transaksi,$diagnosa)
		{
			$strquery=
			"
				UPDATE tb_h_penjualan SET media_transaksi = '".$media_transaksi."', ket_penjualan2 = '".$diagnosa."' WHERE kode_kantor = '".$kode_kantor."' AND id_h_penjualan = '".$id_h_penjualan."'
			";
