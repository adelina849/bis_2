			...
			$query = "
				...
				(
					SELECT
						...
						-- AKSES 3
							,CASE WHEN INDEX_MENU = 31 THEN SUM(AKSES) ELSE 0 END AS AKSES31
							,CASE WHEN INDEX_MENU = 32 THEN SUM(AKSES) ELSE 0 END AS AKSES32
							,CASE WHEN INDEX_MENU = 33 THEN SUM(AKSES) ELSE 0 END AS AKSES33
						-- AKSES 3
