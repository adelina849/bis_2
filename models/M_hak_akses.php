<?php
	Class M_hak_akses extends CI_Model
	{
		...
		function list_hak_akses_limit($id_jabatan,$cari,$limit,$offset)
		{
			$query = $this->db->query("
										SELECT 
										A.id_fasilitas,A.group1,A.main_group,A.sub_group,A.sub_group1,A.sub_group2
										,A.nama_group1,A.nama_main_group,A.nama_sub_group,A.nama_sub_group1,A.nama_sub_group2
										,A.nama_fasilitas,A.keterangan
