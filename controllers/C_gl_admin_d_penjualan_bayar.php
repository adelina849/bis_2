		...
		else
		{
			...
			if(!empty($cek_ses_login))
			{
				...
				if(!empty($data_h_penjualan))
				{
					...
					$data = array('page_content'=>'gl_admin_d_penjualan_bayar','list_d_penjualan_bayar'=>$list_d_penjualan_bayar,'msgbox_title' => $msgbox_title,'list_bank'=>$list_bank,'data_h_penjualan'=>$data_h_penjualan);
			...
			if(!empty($cek_ses_login))
			{
				...
				if(!empty($data_h_penjualan))
				{
					...
					{	
						...
						$this->M_gl_d_penjualan_bayar->edit
						(
					...
					{
						$this->M_gl_d_penjualan_bayar->simpan
						(
							$_POST['id_h_penjualan'],
							$_POST['id_bank'],
							$_POST['id_costumer'],
