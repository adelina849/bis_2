...
class C_gl_admin_lap_h_pembelian extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array('M_gl_lap_pembelian'));
	...
	public function index()
	{
		...
		else
		{
			...
			if(!empty($cek_ses_login))
			{
				...
				$data = array('page_content'=>'gl_admin_lap_h_pembelian','halaman'=>$halaman, 'sum_pesan' => $sum_pesan,'msgbox_title' => $msgbox_title,'list_laporan_h_pembelian' => $list_laporan_h_pembelian,'sum_laporan_h_pembelian' => $sum_laporan_h_pembelian);
