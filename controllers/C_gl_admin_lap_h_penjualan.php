	...
	public function index()
	{
		...
		else
		{
			...
			if(!empty($cek_ses_login))
			{
				...
				$data = array('page_content'=>'gl_admin_lap_h_penjualan','halaman'=>$halaman, 'sum_pesan' => $sum_pesan,'msgbox_title' => $msgbox_title,'list_laporan_h_penjualan' => $list_laporan_h_penjualan, 'sum_laporan_h_penjualan' => $sum_laporan_h_penjualan);
