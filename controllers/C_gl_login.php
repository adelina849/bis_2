<?php
	...
	Class C_gl_login extends CI_Controller
	{
		public function __construct()
		{
			...
			$this->load->model(array('M_gl_hak_akses','M_gl_dashboard'));
		}
		...
		function index()
		{
			...
			{
				header('Location: '.base_url().'gl-admin-login?kode_kantor=KBSMI');
			}
				...
				/*CEK HAK AKSES LEVEL 2*/
					...
					if(!empty($cek_hak_akses_lvl2))
					{
						...
						(
							...
							,'ses_akses_lvl2_31' => $cek_hak_akses_lvl2->AKSES31
							,'ses_akses_lvl2_32' => $cek_hak_akses_lvl2->AKSES32
							,'ses_akses_lvl2_33' => $cek_hak_akses_lvl2->AKSES33
