...
class C_gl_admin_penjualan_langsung extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array('M_gl_costumer','M_gl_h_penjualan','M_gl_media_transaksi'));
	...
	public function index()
	{
		...
		else
		{
			...
			if(!empty($cek_ses_login))
			{
				...
				{
					$data = array('page_content'=>'gl_admin_penjualan_langsung','msgbox_title' => $msgbox_title,'data_costumer_default' => $data_costumer_default,'media_transaksi' => $media_transaksi,'list_kantor' => $list_kantor);
					$this->load->view('admin/container',$data);
				}
				...
				//BUAT SIMPAN H PENJUALAN
					...
					if(!empty($data_no_antrian))
					{
						...
						(
							...
							'CASH',
							$_POST['ket_penjualan'].' (PENJUALAN LANGSUNG)', //$_POST['ket_penjualan'],
