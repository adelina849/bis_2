		...
		else
		{
			...
			if(!empty($cek_ses_login))
			{
				...
				else
				{
					...
					$cari = "WHERE A.kode_kantor = '".$this->session->userdata('ses_kode_kantor')."' AND (A.isAktif = 'DITERIMA' OR A.isAktif = '' OR A.isAktif = '0'  OR A.isAktif = 'PHK' OR A.isAktif = 'MUTASI')";
				}
