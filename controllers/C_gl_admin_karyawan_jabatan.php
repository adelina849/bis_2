	...
	public function index()
	{
		...
		else
		{
			...
			if(!empty($cek_ses_login))
			{
				...
				$list_jabatan  = $this->M_gl_jabatan->list_jabatan(" WHERE kode_kantor = '".$this->session->userdata('ses_kode_kantor')."'",20,0);
				
				$list_dept = $this->M_gl_dept->list_dept_limit(" WHERE kode_kantor = '".$this->session->userdata('ses_kode_kantor')."'",20,0);
