						...
						echo'<tr>';
							...
							*/
							...
							//PILIH THERAPIST
								...
								//echo'<div class="box-body table-responsive no-padding" style="font-size:12px;">';
									echo'<table width="100%" id="table_transaksi" class="table table-hover" style="border:1px solid black;">';
										echo'<thead>';
											echo'<tr style="background-color:grey;color:white;text-align:center;font-size:12px;">';
												echo'<th width="50%" style="text-align:center;border:1px solid black;">TINDAKAN</th>';
												echo'<th width="50%" style="text-align:center;border:1px solid black;">THERAPIST</th>';
											echo'</tr>';
											...
											if(!empty($list_d_penjualan))
											{
												...
												foreach($list_result as $row_d_penjualan)
												{
													...
													echo'<td width="50%" style="text-align:left;width:50%;font-size:12px;border:1px solid black;">'.$row_d_penjualan->nama_produk.'</td>';
													...
													if($row->sts_penjualan != "SELESAI")
													{
														echo'<td width="50%" style="text-align:left;width:50%;font-size:12px;border:1px solid black;">
