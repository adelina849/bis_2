...
class C_gl_pst_karyawan extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array('M_gl_pst_karyawan','M_gl_lap_apoteker','M_gl_keluarga','M_gl_sekolah','M_gl_karyawan_training','M_gl_karyawan_jabatan','M_gl_punish'));
	...
	public function index()
	{
		...
		else
		{
			...
			if(!empty($cek_ses_login))
			{
				...
				{
					$cari = "WHERE A.kode_kantor = '".$kode_kantor."' AND (A.isAktif = 'DITERIMA' OR A.isAktif = '' OR A.isAktif = '0'  OR A.isAktif = 'PHK' OR A.isAktif = 'RESIGN' OR A.isAktif = 'MUTASI')";
				}
