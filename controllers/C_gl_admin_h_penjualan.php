				...
				foreach($list_result as $row)
				{
					...
					else
					{
						...
						echo'<td>
								...
								<button id="pilihass-'.$row->id_karyawan.'-'.$row->nama_karyawan.'" type="button" onclick="insert_therapist(this)" class="btn btn-primary btn-sm" data-dismiss="modal">Pilih</button>
...
<tr>';
	...
	function rekam_medis()
	{
		...
		/*REKAM MEDIS PASIEN*/
			...
			$list_rekam_medis = $this->M_gl_h_penjualan->list_rekam_medis($cari_rekam_medis,$order_by,10,0);
