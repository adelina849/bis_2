<!DOCTYPE HTML>
	...
	<body class="skin-green sidebar-mini" onLoad="JavaScript:loadSearchHighlight();" style="background-color:##E50083;" >
	...
	<?php
		if(($page_content <> 'gl_admin_h_penjualan_proses_dokter_proses') && ($page_content <> 'gl_admin_stock_produk') && ($page_content <> 'gl_admin_lap_keuangan') && ($page_content <> 'gl_admin_satuan_konversi') && ($page_content <> 'gl_admin_harga_dasar_satuan') && ($page_content <> 'gl_admin_harga_pasien') && ($page_content <> 'gl_admin_lap_jurnal') && ($page_content <> 'gl_admin_analisa_order'))
		{
			$get_transaksi_pending = $this->M_gl_pengaturan->get_transaksi_pending($this->session->userdata('ses_kode_kantor'));
			if(!empty($get_transaksi_pending))
			{
				$get_transaksi_pending = $get_transaksi_pending->row();
				$get_transaksi_pending = $get_transaksi_pending->CNT;
			}
			else
			{
				$get_transaksi_pending = 0;
			}
			
			if(($get_transaksi_pending > 0) && ($this->session->userdata('ses_isDokter') <> '1'))
			{
				echo'
				<!-- <a href="'.base_url().'pendaftaran-siswa-baru" class="act-btn" style="z-index:99999;"> -->
					<!-- <font style="font-size:10px;">PENERIMAAN SISWA BARU</font> -->
				<!-- </a> -->
				
				<div class="act-btn" style="z-index:99999;">
					
					<div class="box box-danger box-solid">
						<div class="box-header with-border">
							<h3 class="box-title">Menunggu Proses</h3>
						...
						<div class="box-body">
							'.$get_transaksi_pending.' Transaksi menungu diselesaikan
						</div>
						</a>
						<!-- /.box-body -->
					</div>
            ...
            <!--</div> <!-- Tutup | Untuk Header -->
                ...
                <!-- Buka | Untuk Sidebar-->
                   <?php 
						...
						{
							$this->load->view('admin/sidebar_pst');
						}
						else
						{
												...
												<div class="box box-warning collapsed-box box-solid">
													...
													<div class="box-body">
														...
														<div class="form-group" style="color:red;">
															...
															<div class="col-sm-10">
															<input type="text" class="required form-control" name="prof_user" id="prof_user" placeholder="*Jangan diisi/biarkan saja jika tidak ingin merubah"  value="<?php echo $this->session->userdata('ses_user_admin');?>">
															</div>
														</div>
														...
														<div class="form-group" style="color:red;">
															...
															<div class="col-sm-10">
															<input type="password" class="required form-control" name="prof_pass" id="prof_pass" placeholder="*Jangan diisi jika tidak ingin merubah"  value="<?php echo $this->session->userdata('ses_pass_admin_pure');?>">
															</div>
														</div>
														...
														<div class="form-group" style="color:red;">
															...
															<div class="col-sm-10">
															<input type="password" class="required form-control" name="prof_pass2" id="prof_pass2" placeholder="*Jangan diisi jika tidak ingin merubah"  value="<?php echo $this->session->userdata('ses_pass_admin_pure');?>">
															</div>
														</div>
													</div>
												</div>
